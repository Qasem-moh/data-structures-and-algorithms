...
const addTwo = (arr) => {
  // Solution code here...
  let newArray = [];
  arr.forEach((ele) => newArray.push(ele + 2))
  return newArray
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  // let newarray = []
  // let ind = arr2.filter(function (val) {
  //   let n = !arr1.includes(val)
  //   return n
  // })
  // newarray = ind
  // console.log(ind)

  let specuficItem = arr.filter(function (val, idx) {
    let item = !forbiddenValues.includes(val)
    return item
  })
  return specuficItem
};
